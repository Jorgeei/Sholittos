...
class Colonia extends StatelessWidget {
  const Colonia({Key? key}) : super(key: key);
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text(
                  'Producto diseñado idealmente, para perfumar y mantener las mascotas frescas y con un agradable aroma a talco bb.',
  ...
  _carrusel() {
    return CarouselSlider(
      items: ['assets/COLONIA.png'].map((imagePath) {
        return Container(
          width: 300,
