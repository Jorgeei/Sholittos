...
import 'package:sholittos/src/page/informacion_gato/acarosgato.dart';
...
import '../informacion_gato/dermatitis_solar.dart';
import '../informacion_gato/pulgas_en_gatos.dart';

class ColaG extends StatelessWidget {
  const ColaG({Key? key}) : super(key: key);
