...
import 'package:sholittos/src/page/informacion_gato/dermatitis_alergica.dart';
import 'package:sholittos/src/page/informacion_gato/dermatitis_miliar.dart';
...
class CuelloG extends StatelessWidget {
  const CuelloG({Key? key}) : super(key: key);
            ...
            Row(
              children: [
                Expanded(
                  ...
                  context,
                  'Dermatitis Miliar',
                  'assets/dermatitismiliar.jpeg',
                  const DermatitisMiliar(),
                )),
                ...
                Expanded(
                  ...
                  context,
                  'Dermatitis Alérgica',
                  'assets/dermatitisalergica.jpeg',
                  const DermatitisAlergica(),
                )),
              ],
            ),
            const SizedBox(
